...
<head>
    ...
    <script>
        ...
        function reloadImage(){
            $('#randCode').attr('src','${pageContext.request.contextPath}/admin/code/image?time='+new Date().getTime());
            $('#code').val('');
        }
        $(function(){
                ...
                fields:{
                    ...
                    code:{
                        validators:{
                            ...
                            remote:{
                                url:'${pageContext.request.contextPath}/admin/code/checkCode',
                                message:'验证码不正确'
                            }
                        }
                    }
...
<div class="container div-signin">
    <div class="panel panel-primary div-shadow">
        ...
        <div class="panel-body">
            <!-- login form start -->
            <form id="frmLogin" action="${pageContext.request.contextPath}/admin/sysuser/login" class="form-horizontal" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        <!-- 验证码 -->
                        <img class="img-rounded" id="randCode" src="${pageContext.request.contextPath}/admin/code/image" style="height: 32px; width: 70px;"/>
                    </div>
                    <div class="col-sm-2">
