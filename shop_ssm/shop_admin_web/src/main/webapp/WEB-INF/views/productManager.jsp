...
<head>
    ...
    <script>
        $(function(){
                ...
                fields:{
                    name:{
                        validators:{
                            ...
                            remote:{
                                type:'post',
                                url:'${pageContext.request.contextPath}/admin/product/checkName'
                            }
                        }
                    },
                    price:{
            ...
            $('#pagination').bootstrapPaginator({
                ...
                pageUrl:function(type,page,current){
                    return '${pageContext.request.contextPath}/admin/product/findAll?pageNum='+page;
                }
            });
        });
        //显示商品信息
        function showProduct(id){
            $.post(
                '${pageContext.request.contextPath}/admin/product/findById',
                {'id':id},
                function(result){
                    if(result.code==1){
                        ...
                        $('#img2').attr('src',"/"+result.data.image.substring(result.data.image.indexOf("upload")));
                    }
                }
            );
        }
        ...
        function deleteProduct(){
            $.get(
                '${pageContext.request.contextPath}/admin/product/delete',
                ...
                function(result){
                    if(result.code==1){
                        layer.msg('删除成功',{
                            ...
                            //重新加载数据
                            location.href='${pageContext.request.contextPath}/admin/product/findAll?pageNum='+${productPageInfo.pageNum};
                        })
                    }else{
                        layer.msg('删除失败',{
                            time:2000,
...
<div class="modal fade" tabindex="-1" id="Product">
    ...
    <div class="modal-dialog modal-lg">
        <!-- 内容声明 -->
        <form action="${pageContext.request.contextPath}/admin/product/add" id="frmAddProduct" class="form-horizontal" method="post" enctype="multipart/form-data">
                ...
                <div class="modal-body text-center row">
                    <div class="col-sm-8">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <select class="form-control" name="productTypeId" id="product-productTypeId">
...
<div class="modal fade" tabindex="-1" id="myProduct">
    ...
    <div class="modal-dialog modal-lg">
        <!-- 内容声明 -->
        <form action="${pageContext.request.contextPath}/admin/product/edit" class="form-horizontal" method="post" enctype="multipart/form-data">
            <div class="modal-content">
                <!-- 头部、主体、脚注 -->
                <div class="modal-header">
                    <button class="close" data-dismiss="modal">&times;</button>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button class="btn btn-primary updateProType" onclick="deleteProduct()" data-dismiss="modal">删除</button>
                <button class="btn btn-primary cancel" data-dismiss="modal">取消</button>
            </div>
        </div>
    </div>
