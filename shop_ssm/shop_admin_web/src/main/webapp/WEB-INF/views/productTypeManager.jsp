...
<head>
    ...
    <script type="text/javascript">
        $(function(){
            ...
            $('#pagination').bootstrapPaginator({
                ...
                pageUrl:function(type,page, current){
                    return '${pageContext.request.contextPath}/admin/productType/findAll?pageNum='+page;
                },
        ...
        function addProductType(){
            $.post('${pageContext.request.contextPath}/admin/productType/add',
                ...
                function(result){
                    if(result.code==1){
                        layer.msg(result.message,{
                            ...
                            location.href='${pageContext.request.contextPath}/admin/productType/findAll?pageNum='+${pageInfo.pageNum};
                        });
                    }else{
                        layer.msg(result.message,{
                            time:2000,
        ...
        function showProductType(id){
            $.post(
                '${pageContext.request.contextPath}/admin/productType/findById',
                {'id':id},
                function(result){
                    if(result.code==1){
        ...
        function modifyName(){
            $.ajax({
                type:'post',
                url:'${pageContext.request.contextPath}/admin/productType/modifyName',
        ...
        function deleteProductType(){
            $.get(
                '${pageContext.request.contextPath}/admin/productType/removeById',
        ...
        function modifyStatus(id,btn){
            $.get(
                '${pageContext.request.contextPath}/admin/productType/editStatus',
                {'id':id},
                function(result){
                    if(result.status==1){
                        //局部刷新
